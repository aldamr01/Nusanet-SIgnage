...
class SnackMarquee {
    ...
    constructor(options) {
        ...
        let { selector, mode, color, background, speed, space, font, size, width, height, children } = Object.assign(opt, options);
        this.flag = 0;
    ...
    build() {
        ...
        let textBox = [
            '<div class="slide0 snackslide" style="top:10px;"></div>',
